...
#CREATING SPARTA TABLE
spartans = spartans[['behaviour_id', 'name', 'trainer_id', 'course_id', 'course_name', 'date']]
course = course.drop_duplicates(subset=['course_name', 'course_id']).reset_index(drop=True)
